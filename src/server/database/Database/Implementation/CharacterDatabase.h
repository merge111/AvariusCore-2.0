...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_PLAYER_ALREADY_ANSWERED_QUESTIONS,
    CHAR_SEL_PLAYER_ALREADY_ANSWERED_QUESTIONS_ACCOUNTID_COUNT,
    CHAR_INS_PLAYER_QUESTIONS_AND_ANSWERS,
    ...
    //PlayTime Rewards
    CHAR_SEL_PLAYTIME_REWARDS,
    CHAR_INS_PLAYTIME_REWARDS,
    
    /* ITEM CODES */
    CHAR_INS_ITEMCODE,
    CHAR_SEL_ITEMCODE,
    CHAR_INS_ITEMCODEACCOUNT,
    CHAR_SEL_ITEMCODEACCOUNT,
    CHAR_UPD_ITEMCODEUSED,
    CHAR_SEL_COUPON_REWARD,
    ...
    CHAR_INS_REPORT_ERROR_MESSAGE,
    
    //Cusom XP
    CHAR_INS_CUSTOM_XP,
    CHAR_SEL_CUSTOM_XP,
    CHAR_UPD_CUSTOM_XP,
    CHAR_SEL_CUSTOM_XP_VALUE,
    
    //FirstCharacter
    CHAR_SEL_FIRST_CHAR_PLAYERLOG,
    CHAR_SEL_GUILD_CREATE_DATE,
    CHAR_SEL_GUILD_MEMBER_COUNT,
    CHAR_UPD_FIRSTCHARACTER_TO_ZEROACCOUNT,
    CHAR_CHECK_IF_PLAYER_HAS_ALREADY_CHARACTERS,
